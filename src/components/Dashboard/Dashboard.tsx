...
const Dashboard: React.FC = () => {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", margin: 0, justifyContent: "center", alignItems: "center" }}>
      <div className='containerInfoInput'>
      ...
      <div className='containerData'>
        ...
        <input placeholder='Insira o nome da tarefa' className='styledInput' id="card-name-input" type='text' value={newCardName} onChange={(event) => setNewCardName(event.target.value)}/>
        <label>Prioridade da Tarefa</label>
        <select className='styledSelect' id="priority-input" onChange={(event) => setNewCardPriority(Number(event.target.value))}>
